<?php
/**
 * Template Name: My401k Basic Page
...
<html><head>
  ...
  <link rel="stylesheet" href="http://localhost:3637/tinymce/jscripts/tiny_mce/themes/advanced/skins/default/ui.css"><link rel="stylesheet" href="http://localhost:3637/tinymce/jscripts/tiny_mce/plugins/inlinepopups/skins/clearlooks2/window.css"></head>
        ...
        <div id="body">
          <div id="left">
            <div class="xeasy-browse" id="logo">
              ...
              <div class="logo-graphic corporate first">{My 401K Made Easy Logo}<div class="ribbon-shadow"></div></div>
      ...
      <div class="body">
        ...
        <div class="entry">
          ...
          <div id="center-right">
            ...
            <div id="mid-section">
<div id="banner"></div>
<div id="topic">About Plan</div>

<div class="" id="content">
        <div class="section-bar">
        <div class="section-bar-side left"></div>
        <div class="section-bar-side right"></div>
        <div class="bar-title"><p class="title">Featured Content</p></div><div class="bar-actions"></div>
      </div>
  ...
  <div class="tile-row">
        ...
        <div class="head">
          ...
          <div class="title">
      rhoncus ut imperdiet a venenatis</div>
        ...
        <div class="head">
          ...
          <div class="title">
      vulputate eget arcu In enim</div>
          <div class="line-break"></div>
        </div>
        <div class="body">
          <div class="content">      Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis      
</div>
          <div class="action">Read more</div>
        </div>
      </div>
        ...
        <div class="head">
          <div class="graphic icon-forms"></div>
          <div class="title">
      In enim justo rhoncus ut</div>
          <div class="line-break"></div>
        </div>
        <div class="body">
          <div class="content">      Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
</div>
          <div class="action">Read more</div>
        </div>
      </div>
      ...
      imperdiet a venenatis vitae justo</div>
        ...
        <div class="body">
          <div class="content">      Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu.
</div>
          <div class="action">Read more</div>
        </div>
      </div>
        ...
        <div class="section-bar-side left"></div>
        <div class="section-bar-side right"></div>
        <div class="bar-title"><p class="title">Content Directory</p></div><div class="bar-actions">    <div class="bar-action first search"><div class="magnifying-glass"></div></div>
</div>
      </div>
  ...
  <div class="tile-row">
        ...
        <div class="head">
          <div class="graphic icon-sponsor"></div>
          <div class="title">
      Phasellus viverra nulla.</div>
          <div class="line-break"></div>
        </div>
        <div class="body">
          <div class="content">      Aenean massa odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus.
</div>
          <div class="action">Read more</div>
        </div>
      </div>
      ...
      Vulputate eget arcu In enim.</div>
        ...
        <div class="body">
          <div class="content">      Integer commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis      
</div>
          <div class="action">Read more</div>
        </div>
      </div>
        ...
        <div class="head">
          <div class="graphic icon-sphere"></div>
          <div class="title">
      Etiam rhoncus; maecenas.</div>
          <div class="line-break"></div>
        </div>
        <div class="body">
          <div class="content">      Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi.
</div>
          <div class="action">Read more</div>
        </div>
      </div>
      ...
      Duis leo; sed fringilla.</div>
        ...
        <!-- for debugging/design purposes -->
    <script type="text/javascript" src="/demo/demo.js"></script>

    <div style="display: none; " id="dialogs">
      <!-- show details for a layer -->
      <div title="layer details" id="details">
        <p class="info"></p>
        <form>
      ...
      <!-- modify the z-index value -->
      <div title="set z-index" id="zIndex">
        <form>
        <input type="text">
      ...
      <!-- modify the layer dimensions -->
      <div title="modify dimensions" id="dimensions">
        <div class="info"></div>
        <p></p>
        <form>
        Offset: <input type="text" value="10" name="offset"><br>
        <div class="dim-width">Width: <input type="text" name="value"><input type="button" value="[-]"><input type="button" value="[+]"><input type="button" value="fit"><input type="button" value="auto"></div>
        <div class="dim-height">Height: <input type="text" name="value"><input type="button" value="[-]"><input type="button" value="[+]"><input type="button" value="fit"><input type="button" value="auto"></div>
        <div class="dim-top">Top: <input type="text" name="value"><input type="button" value="[-]"><input type="button" value="[+]"><input type="button" value="fit"></div>
        <p></p>
        <input type="submit" value="ok">
        </form>
      </div>
      ...
      <!-- notes -->
      <div class="info">
        Images need to be resized/increased by 136%.

        Slicing images:
        http://registry.gimp.org/node/12636
        http://registry.gimp.org/node/14953
        http://registry.gimp.org/node/16789

        Installing plugins (Gimp): 
...
<script>
  //keyLayers[keyLayers.length] = "#blog-entry-sample";
  var keyLayers = "#blog-entry-sample".split(/\s*,\s*/);

  function showProgress(button){
    var cover = $(button).find(".cornered-button-cover")
    
    if(cover.length &gt; 0){
      if($(button).data("working") == true){
        return false;

      } else {
        $(cover).css("width", $(button).width()).css("height", $(button).height()).spin();
  ...
  function stopProgress(button){
    var cover = $(button).find(".cornered-button-cover")
    if(cover.length &gt; 0){
      $(cover).css("width", "auto").css("height", "auto").spin().stop();
      $(button).data("working", false);
    }
  }
